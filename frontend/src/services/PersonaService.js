export default class PersonaService {
    constructor(userId) {
        ...
        this.mockPersonas = [
            ...
            {'userId': '106396242553744029996', 'id': 4, 'name': 'First Foobar', 'content': "You are a Fizz Buzz!"},
            {'userId': '106396242553744029996', 'id': 5, 'name': 'Second Foobar', 'content': "You are also a Fizz Buzz!"}
        ];
    }
