...
+ Kiara
  ...
  * [X] carousel for personas page (from generate)
+ Shumin
...
+ Ewan
  + code cleanup
  + fix Threads on deployment
  + Home/Dashboard/About paragraph
  + Delete Settings link / route / page
  + Get rid of all session management cruft
  + Update linkPlatform in AuthController to use only the pid (no need for UID)    
+ Kiara
  + code cleanup  
